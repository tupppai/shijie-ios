...
class PPGiftShowsAnimateView: UIView {
    ...
    var giftQueue:Queue<String> = Queue()
    ...
    func show() {
        ...
        let delayTime2 = dispatch_time(DISPATCH_TIME_NOW, Int64(10 * CGFloat(NSEC_PER_SEC)))
    ...
    func showGiftShowView1() {
        ...
        let delayTime = dispatch_time(DISPATCH_TIME_NOW, Int64(4 * CGFloat(NSEC_PER_SEC)))
        dispatch_after(delayTime, dispatch_get_main_queue()) {
