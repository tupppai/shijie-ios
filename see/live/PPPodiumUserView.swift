...
//            
    ...
    override init(frame: CGRect){
        user = PPUserModel_toremove(avatarImageUrl: "nil", username: "nil", coinsContributed: 0, ranking: 0)
        rank = 0
    ...
    convenience init(user: PPUserModel_toremove, rank: Int){
        self.init(frame: CGRect.zero)
        self.user = user
        self.rank = rank
    }
