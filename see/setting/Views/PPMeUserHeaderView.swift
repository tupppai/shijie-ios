...
class PPMeUserHeaderView: UIView {
    ...
    var rollRankViewTappedClosure: (() -> Void)?
    ...
    private func setupSubviews(){
        ...
        let tapOnRollRankListView =
        UITapGestureRecognizer(target: self, action: #selector(PPMeUserHeaderView.tapOnRollRankListView(_:)))
        rollRankListView.addGestureRecognizer(tapOnRollRankListView)
    ...
    // MARK: target-actions
    func tapOnRollRankListView(recognizer: UITapGestureRecognizer){
        rollRankViewTappedClosure?()
    }
